    ...
    class Program
    {
        ...
        public static void News_check()
        {
            for (int t = 0; j != t && url[0] != ""; t++)
            {
                ...
                if (result != null)
                {
                    Regex reg1 = new Regex("csrf_token", RegexOptions.IgnoreCase);
                    ...
                    string filePath = @"C:\Users\satoshi\Desktop\Projects\1.text";
                    System.Text.Encoding enc = System.Text.Encoding.GetEncoding("shift_jis");
                    System.IO.File.WriteAllText(filePath, text, enc);
                    string filePath2 = @"C:\Users\satoshi\Desktop\Projects\2.text";
